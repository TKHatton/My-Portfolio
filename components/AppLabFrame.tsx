  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-32 group">
      <div className="order-2 lg:order-1">
        <span className="text-xs font-black uppercase tracking-[0.5em] text-plum mb-6 block italic">App Prototype</span>
      ...
      >
        <div className="relative bg-charcoal p-4 rounded-[3rem] shadow-2xl overflow-hidden aspect-[4/3] border-[10px] border-charcoal">
          ...
          {/* Label Tag */}
          <div className="absolute top-8 right-8 bg-coral text-white text-xs font-black px-4 py-2 rounded-full uppercase tracking-widest shadow-lg">
             Experimental
          </div>
        </div>
        {/* Subtle shadow glow */}
